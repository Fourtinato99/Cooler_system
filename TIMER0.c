...
arguments    :
              -prescalar     -> prescalar of the clock.
              -trig_a        ->the value of the compare match of register A that the pin we be trigger on it.
			  -trig_B        ->the value of the compare matchof register B that the pin we be trigger on it.
			  -inverting_a   ->determine the inverting or non-invering of OC0A.     0=> non-inverting
			  -inverting_a   ->determine the inverting or non-invering of OC0B.     0=> non-inverting
...
void TIMER0_update_OCRA_OCRB(uint8 A , uint8 B)
{
	TC0_OCR_A = A;
	TC0_OCR_B = B;
